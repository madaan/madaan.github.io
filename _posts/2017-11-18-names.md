...
The other day I was talking to a friend who wanted to know if there is an app to generate new names given a country. I 
didn't know the answer, but it got me thinking about names. I found a [dataset of names](https://mbejda.github.io/),
thanks to [mbejda](https://github.com/mbejda). The dataset consists of Hispanic, Indian, Caucasian and African American
names. Now perhaps you have read this [fantastic blog](http://karpathy.github.io/2015/05/21/rnn-effectiveness/) on RNNs
and what they do.
